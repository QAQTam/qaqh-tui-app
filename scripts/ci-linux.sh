...
#
# 后端侧对应 rev `72b68091b7bed688ed84b5a1f5d28b036650d7a5`：
# **Ringing v2 typed bootstrap + interaction content + timeline/session/command
# cutover + per-seed single stream + canonical approvals**（后端
# `feat/v2-approvals-cutover`）。旧锚点：
# `tui-ringing-v2-interaction-causation-2026-09-24` @ `b77c251`。
# 该 rev 尚待后端合入 main 并另发不可移动 tag；tag 落地后只替换下方 SHA
# 并补 tag 注释。
...
QAQH_BACKEND_REV="${QAQH_BACKEND_REV:-72b68091b7bed688ed84b5a1f5d28b036650d7a5}"
